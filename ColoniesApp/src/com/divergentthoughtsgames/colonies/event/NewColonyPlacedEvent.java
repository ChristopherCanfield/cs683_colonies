...
/**
 * Signals that a new colony has been placed.
 * @author Christopher D Canfield
 */
public final class NewColonyPlacedEvent extends GameEvent<NewColonyPlacedData>
{
	private static final long serialVersionUID = -8143708692505549511L;
	public static final long ID = serialVersionUID; 
	
	public NewColonyPlacedEvent(NewColonyPlacedData data)
	{
		super(ID, data);
	}
