 ...
 */
public abstract class GameEvent<T> implements Serializable
{
	private static final long serialVersionUID = 5448900965485031019L;
	 ...
	 */
	public GameEvent(long eventId, T data)
	{
		this.data = data;
