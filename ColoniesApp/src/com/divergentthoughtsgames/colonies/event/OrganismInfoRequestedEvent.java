...
/**
 * Signals that an object has requested information
 * about the specified Organism.
 * @author Christopher D Canfield
 */
public final class OrganismInfoRequestedEvent extends GameEvent<GridPosition>
{
	private static final long serialVersionUID = 4916649306972689445L;
	public static final long ID = serialVersionUID; 
	
	public OrganismInfoRequestedEvent(GridPosition location)
	{
		super(ID, location);
	}
	...
	{
		return "OrganismInfoRequestedEvent";
	}
}
