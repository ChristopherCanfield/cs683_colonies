...
/**
 * Signals that an Organism has been popped.
 * @author Christopher D. Canfield
 */
public class OrganismPoppedEvent extends GameEvent<GridPosition>
{
	private static final long serialVersionUID = -3060616859666177043L;
	public static final long ID = serialVersionUID;

	public OrganismPoppedEvent(GridPosition data)
	{
		super(ID, data);
	}
