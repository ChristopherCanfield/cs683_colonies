...
/**
 * A request to have all Organism's send data to entities subscribed
 * to the AllOrganismsRequestedResponseEvent.
 * @author Christopher D Canfield
 */
public final class AllOrganismsRequestedEvent extends GameEvent<Object>
{
	private static final long serialVersionUID = 7991434804419441418L;
	public static final long ID = serialVersionUID; 

	public AllOrganismsRequestedEvent()
	{
		super(ID, null);
	}
	...
	{
		return "AllOrganismsRequestedEvent";
	}
}
