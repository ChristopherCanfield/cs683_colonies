...
/**
 * Signals that a new organism has been born.
 * @author Christopher D Canfield
 */
public final class OrganismBornEvent extends GameEvent<OrganismBornData>
{	
	private static final long serialVersionUID = -8654639307288809971L;
	public static final long ID = serialVersionUID; 
	
	public OrganismBornEvent(OrganismBornData data)
	{
		super(ID, data);
	}
